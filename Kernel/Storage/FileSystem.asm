...
struc FileSystem
	...
	.loadFile			resd 1	;IN: eax = file, ebx = buffer
	.loadFiles			resd 1	;IN: eax = directory
	.loadSubDirs		resd 1	;IN: eax = directory
	.struc_size:
endstruc

struc Directory
	.references			resd 1	;number of references to this directory, bit 31 is a lock for referencing any subdirectories/files.
	...
	.name				resd 1	;pointer to the name of this directory (0 terminated string)
	.struc_size:
endstruc
