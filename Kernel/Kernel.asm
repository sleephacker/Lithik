...
;include file generated by asm_constants.py, must be generated before assembling, ofcourse
%include "Kernel\Macro\AutoConstant.asm"

%include "Kernel\Macro\Stack.asm"
%include "Kernel\Macro\SpinLock.asm"
%include "Kernel\Macro\SmartPointer.asm"
%include "Kernel\Macro\TicketLock.asm"
;%include "Kernel\Macro\SSE.asm"
%include "Kernel\Macro\Color.asm"
...
boot:
	...
	xchg al, bl
	out 71h, al
	;read status register C to acknowledge pending RTC interrupts, fixes Bochs but breaks VirtualBox sometimes???
	mov al, 0ch
	out 70h, al
	in al, 71h
	;Send an EOI for good measure, fixes bugs in VirtualBox caused by Bochs bug prevention measures... :)
	mov al, 20h	
	out 00a0h, al
	out 0020h, al
	;initialize PIT
	...
	;FIXED!!! http://forum.osdev.org/viewtopic.php?f=11&t=31696&p=274399#p274399
...
;TODO: according to omarrx024 ( http://forum.osdev.org/viewtopic.php?f=1&t=31400&p=272226#p272226 ) this should be aligned
...
%include "Kernel\Stream\Stream.asm"
